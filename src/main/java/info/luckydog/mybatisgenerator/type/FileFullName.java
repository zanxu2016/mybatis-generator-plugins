...
public class FileFullName {
    ...
    public FileFullName(String fileFullName) {
        ...
        this.pathName = fileFullName.substring(0, Math.max(index0, 0));
        this.typeShortName = fileFullName.substring(index0 + 1, Math.max(index1, index0 + 1));
    ...
    public FileFullName(String pathName, String fileShortName) {
        ...
        this.pathName = pathName;
        this.typeShortName = fileShortName.substring(0, Math.max(index0, 0));
